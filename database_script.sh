...
CREATE DATABASE IF NOT EXISTS ${DB_DATABASE} CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
GRANT ALL PRIVILEGES ON ${DB_DATABASE}.* TO '${DB_USER}'@'${NEXTCLOUD_PRIVATE_IP}';
